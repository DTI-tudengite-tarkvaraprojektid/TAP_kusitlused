...
<nav>
    <div class="nav-wrapper teal darken-1">
        <a href="" class="brand-logo center" style="margin-top: 10px;"><span class="logo grey-text text-lighten-5"><img class="responsive-img" style="height: 40px" src="../assets/img/logo.png"></span></a>
    </div>
</nav>
...
<div class="container">
    ...
    <div class="row" id="quizzes">
        <h2 style="text-align: center"><?=$questionnaire_name->questionnaire_name?></h2><br><br>
                ...
                <?php if ($q->question_type == "0") { ?>
                    <div class="input-field">
                        ...
                        <input type="text" id="<?php echo $q->question_id ?>" required placeholder="Vastuse tekst..."
                               ...
                               oninput="setCustomValidity('')" required></input><br><br>
                    </div>
